...
.projection{{fill:none;stroke:var(--control);stroke-width:4.2;stroke-dasharray:8 7}}
...
@media(prefers-reduced-motion:reduce){{*{{animation:none!important;transition:none!important}}}}
    ...
    parts += [
        ...
        '<circle cx="1335.4" cy="366.8" r="6" fill="var(--control)" stroke="var(--panel)" stroke-width="2"/>',
        '<text x="1288" y="340" class="math" font-size="16" fill="var(--control)">d(x,H)</text>',

        '<line x1="1160" y1="524" x2="1525" y2="524" stroke="var(--line)"/>',
        '<text x="1160" y="560" class="math eq">d(x,H) = |aᵀx − b| / ‖a‖₂</text>',
        '<text x="1160" y="590" class="small">red dashed = boundary · Light Sky Blue dashed = orthogonal projection</text>',
