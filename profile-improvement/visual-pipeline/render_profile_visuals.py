...
def hero():
 W,H=2048,640; b=[header(W,H,'Dossiya Dakou — Mathematical Systems Engineering for Sustainable Resilience','White-canvas mathematical research identity with multilayer infrastructure, canonical interdependency object, viability geometry, synthetic nonlinear dynamics and state-space geometry.','MATHEMATICAL SYSTEMS ENGINEERING | SUSTAINABILITY · RESILIENCE · OPTIMIZATION | ẋ = f(x,u,η) | ρ(x)=d(x,∂V) | EVIDENCE → MODEL → COMPUTE → VERIFY → VALIDATE → DECIDE | synthetic illustrative data, not empirical evidence.')]
 ...
 b += [line(400,266,650,266,HAIR,1),line(1398,266,1648,266,HAIR,1),text(1024,325,'Dossiya Dakou',72,'middle','700',family=SERIF),text(1024,363,'Mathematical Systems Engineering for Sustainable Resilience',25,'middle',style='italic',family=SERIF),text(1024,392,'POWER · TRANSPORTATION · INFORMATION · ORGANIZATION',15,'middle','700')]
