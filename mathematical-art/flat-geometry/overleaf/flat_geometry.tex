...
\begin{tikzpicture}[x=1cm,y=1cm,>=Latex,every node/.style={text=Ink}]
  ...
  \draw[Gold,->,line width=1pt] (13.05,3.95) -- (13.75,3.28);
  \node[text=Gold,font=\scriptsize] at (13.28,3.43) {$d(x,H)$};
  \node[text=Green,font=\scriptsize,anchor=west] at (11.95,1.25) {admissible side};
